...
<table>
  <tr>
    ...
    <td><!-- LATEST_OSS:start -->Last open source merge: <a href="https://github.com/BunsDev"><b>BunsDev</b></a> <a href="https://github.com/BunsDev/coven-feedback/pull/1">#1</a> — <i>feat(db): add widget_events table for lifecycle instrumentation</i> &middot; 3 months ago.<!-- LATEST_OSS:end --></td>
  </tr>
  <tr>
