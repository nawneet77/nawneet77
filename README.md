...
<table>
  <tr>
    ...
    <td><!-- LATEST_OSS:start -->Last open source merge: <a href="https://github.com/OpenCoven"><b>OpenCoven</b></a> <a href="https://github.com/OpenCoven/coven/pull/51">#51</a> — <i>fix(api): reject non-integer limit and afterSeq with structured 400</i> &middot; yesterday.<!-- LATEST_OSS:end --></td>
  </tr>
  <tr>
