...
<table>
  <tr>
    ...
    <td><!-- LATEST_OSS:start -->Last open source merge: <a href="https://github.com/OpenCoven"><b>OpenCoven</b></a> <a href="https://github.com/OpenCoven/feedback/pull/1">#1</a> — <i>feat(db): add widget_events table for lifecycle instrumentation</i> &middot; 1 month ago.<!-- LATEST_OSS:end --></td>
  </tr>
  <tr>
